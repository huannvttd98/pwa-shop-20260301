  ...
  <div class="p-4 md:p-6 lg:p-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
      ...
      <button @click="openAddModal"
        class="flex items-center justify-center space-x-2 px-6 py-3 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-colors font-medium">
        ...
        <div class="p-5">
          ...
          <div class="flex gap-2">
            <button @click="openEditModal(product)"
              class="flex-1 py-2 px-4 bg-indigo-100 text-indigo-600 rounded-xl hover:bg-indigo-200 transition-colors font-medium text-sm">
              Sửa
            </button>
