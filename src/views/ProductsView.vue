  ...
  <div class="p-4 md:p-6 lg:p-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
      ...
      <button @click="openAddModal"
        class="flex items-center justify-center space-x-2 px-6 py-3 bg-rose-400 text-white rounded-xl hover:bg-rose-500 transition-colors font-medium">
        ...
        <div class="p-5">
          ...
          <div class="flex gap-2">
            <button @click="openEditModal(product)"
              class="flex-1 py-2 px-4 bg-rose-100 text-rose-500 rounded-xl hover:bg-rose-200 transition-colors font-medium text-sm">
              Sửa
            </button>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-4">
        <div>
          ...
          <input v-model="formData.name" type="text" required
            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-rose-300 focus:border-transparent"
        ...
        <div>
          ...
          <textarea v-model="formData.description" rows="3"
            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-rose-300 focus:border-transparent resize-none"
